...
HD_PWD='/home/bdwatkin/Desktop/Lab_6/Lab_6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab6Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab6Top.tcl -notrace
