...
HD_PWD='/home/bdwatkin/Desktop/Lab_6/Lab_6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab6Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab6Top.tcl
